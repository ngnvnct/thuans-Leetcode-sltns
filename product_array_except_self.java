...
public class product_array_except_self {
    ...
    public void testProductSelf() {
        ...
        int[] expectedOne = {24,12,8,6};
        int[] expectedTwo = {0,0,9,0,0};
        assertArrayEquals(expectedOne, productExceptSelfMethodOne(exampleOne));
        assertArrayEquals(expectedOne, productExceptSelfMethodTwo(exampleOne));
        assertArrayEquals(expectedTwo, productExceptSelfMethodOne(exampleTwo));
        assertArrayEquals(expectedTwo, productExceptSelfMethodTwo(exampleTwo));
    }
}
