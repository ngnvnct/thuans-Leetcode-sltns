public class remove_nth_end_ll {
...
/*
Explanation
Making a dummy node and point the fast and slow to it. After you move the fast node so the gap between slow and fast become n.
