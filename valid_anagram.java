...
public class valid_anagram {
    ...
    public void testAnagram() {
        ...
        assertEquals(true, isAnagramSort("anagram", "nagaram"));
        assertEquals(false, isAnagramSort("rat", "cat"));
        assertEquals(false, isAnagramSort("anagram", "agaram"));
    }
...
Sorting: O(n log n) time, in Java toCharArray makes a copy so it will be O(n) space, otherwise it is O(1) space (language dependent detail)
...
Make a hash map with similar concept to the bucket, and loop throught the values if it is negative it is not an anagram
Time: O(n)
Space: O(n)
*/