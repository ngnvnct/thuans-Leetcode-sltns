...
The key take away is the array is sorted. So the start and the end element have the potential to be the largest. 
We take the absolute value of the start and end element and use Two Pointers approach
