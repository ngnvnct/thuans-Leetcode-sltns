...
public class Extract_String_To_Integer {
    ...
    public void testExtract() {
        assertEquals(new ArrayList<>(Arrays.asList(2, 1, 3, 5, 67, 2)),
                extract(new String[] { "A2D", "1B", "3F5", "67FE2", "AA" }));
        assertEquals(new ArrayList<>(Arrays.asList(2, 1, 3, 5, 60, 2, 0)),
                extract(new String[] { "A2D", "1B", "3F5", "60FE2", "A0A" }));
        assertEquals(new ArrayList<>(Arrays.asList(2, 1, 3, 5, 60, 22, 0, 0)),
                extract(new String[] { "A2D", "1B", "3F5", "60FE022", "A0A0" }));
    }
}
