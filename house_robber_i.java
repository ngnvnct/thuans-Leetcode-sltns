...
/*
Explanation
Bottom up DP Problem. A space optimization is we only need the last 2-steps back value, so we can hold them in 2 variables instead. It is similar to Fibonacci Problem
