...
public class unique_paths_ii {
    ...
    public static void main(String[] args) {
        ...
        unique_paths_ii sol = new unique_paths_ii();
...
But, the difference is that we have to check if the obstacle grid has a 1 in it, if it exists a 1 then that cell has a solution of 0
In Java when you initialize an array, it fills with 0, by doing a check to see if the obstacle grid is not 1, we can do the calculation, and doesn't have to set that cell to 0
