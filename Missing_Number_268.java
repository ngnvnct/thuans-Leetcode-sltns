 ...
 * So we can just calculate the sum of the array, and take the sum from 0 to n
 * subtract by the sum array
 * 
 * Bit Manipulation
 * XOR
 * Input - Output
 ...
 * 1 | 1 - 1
 * 
 * [9,6,4,2,3,5,7,0,1] XOR with [0,1,3,4,5,6,7,8,9], everything will be cancel
 * out except for the missing number
 * 
 * 9 ^ 9 ^ 0 = 0
 ...
 * Space: O(1)
 * 
 * Hypothetical, the array is sorted, we can do binary search then the idea is
 * to find the first number such that index != nums[index]
 * [0,1,2,3,4,5,6,7,9]
